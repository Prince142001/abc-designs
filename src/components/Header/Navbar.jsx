  ...
  return (
    <>
      <nav
        ...
        style={{ zIndex: 90 }} // Lower than header (100)
      >
      ...
      <header
        className="max-w-384 mx-auto fixed top-0 left-1/2 -translate-x-1/2 w-full px-4.5 md:px-6.25 xl:px-28 py-5 md:py-8 flex items-center justify-between header"
        style={{ zIndex: 100 }}
      >
        <div>
          <Link
